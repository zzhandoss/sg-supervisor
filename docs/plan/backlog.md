...
- Decide whether update/backup actions should get their own operator-facing UI or remain CLI/API-only for now, now that core + adapter pre-update backups are confirmed on Windows.
